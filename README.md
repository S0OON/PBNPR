...
![How to use the addon](/resource/img/UI_Guide_New.jpg)
...
1.Code/bpy_glsl_manager/* addon's internals.

2.resource/* LFS resource stuff with source_examples; have some GLSL shaders to test on.



> For developers

One pholosophy used here is that any .py has the same access when ever, and thus the cusomizablilty is all up to you, like even spawining a cube middle of registeration, who cares!
...
Ultimate customizability. Ultimate performance._